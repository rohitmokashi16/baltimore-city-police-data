...
class CrimeVisualizations:
	...
	def day_of_the_week_boxplot(self, groupby = "Year", lower_year = 2016, upper_year = 2020, is_swarm = True, neighborhood_name = None, crime_type = None):
		...
		neighborhood_name: contains name of ONE neighborhood
		crime_type: contains name of ONE type of crime, subset of Description column of dataset"""
	...
	def district_wise_boxplot(self, groupby = "Year", lower_year = 2016, upper_year = 2020, is_swarm = True):
...
def main():
	...
	dotw_year_noswr = crime_viz.day_of_the_week_boxplot("Year", lower, upper, False, 'Downtown', 'Arson')
	dotw_year_swarm = crime_viz.day_of_the_week_boxplot("Year", lower, upper, True, 'Downtown', 'Arson')
	in_ou_trends_year = crime_viz.indoor_outdoor_crimes_trends("Year", lower, upper, 'Downtown', 'Arson')
	in_ou_trends_mnth = crime_viz.indoor_outdoor_crimes_trends("Month_Number", lower, upper, 'Downtown', 'Arson')
	in_ou_trends_week = crime_viz.indoor_outdoor_crimes_trends("WeekNumber", lower, upper, 'Downtown', 'Arson')
